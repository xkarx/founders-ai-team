...
- `webapp/`: the local GUI, with a docs browser, a Kanban backlog board, and per-role AI chat (plus a "Propose to team" feature that fans a question out to every agent at once and can turn the resulting discussion into a backlog card)
