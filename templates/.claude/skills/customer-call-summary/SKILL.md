...
description: Style guide for summarizing {{COMPANY_NAME}} customer/prospect calls
---

# Customer Call Summary Style Guide

Defines how to summarize a call with a customer or prospect.
...
Organized by topic, table format:

```markdown
### [Topic]
| Insight | Details |
|---------|---------|
| **[headline]** | [description]<br><br>*"[quote]" - [speaker]* |
```
...
| Feature | Details |
|---------|---------|
| **[name]** | [description]<br><br>*"[quote]" - [speaker]* |
```
