...
|------|------|--------------|
| Feature index | `product-development/feature-index.yaml` | Every feature mapped to its PRD, plan, metrics |
| Product | `product-development/product/CLAUDE.md` | Product context, pillars, users |
| PRDs | `product-development/product/PRDs/CLAUDE.md` | Product requirement docs, one per feature |
